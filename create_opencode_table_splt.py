...
def main():
    ...
    parser.add_argument("--count", help="optional argument", dest="count", default=1)
    ...
    for i in range(count):
       fileList.append(open(f'data/opencode_table_{i}.csv', 'w+', encoding='UTF-8'))
    ...
    for balls in ballsList: # ALL
        ...
        print (balls)
        file = None
        if balls[0] == 1 and balls[1] == 2:
            file = fileList[0]
        elif balls[0] == 1 and balls[1] == 3:
            file = fileList[1]
        elif balls[0] == 1 and balls[1] == 4:
            file = fileList[2]
        elif balls[0] == 1 and balls[1] == 5:
            file = fileList[3]
        elif balls[0] == 1 and balls[1] == 6:
            file = fileList[4]
        elif balls[0] == 1 and balls[1] == 7:
            file = fileList[5]
        elif balls[0] == 1 and balls[1] == 8:
            file = fileList[6]
        elif balls[0] == 1 and balls[1] == 9:
            file = fileList[7]
        else:
            break
        ...
        file.write(strBalls + "," + strColumnsWithComma + "\n")
