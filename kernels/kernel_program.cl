...
/*
__kernel void find_best_amount_count(__global float *opencode_amount_list,
  ...
  if (amount_range1 <= amount && amount <= amount_range2) {
    ...
    // opencode_amount_list[numbers_index]);
    atomic_inc(count_result);
  }
}

__kernel void
find_best_amount(__global float *opencode_amount_list,
                 ...
                 const float amount_range1, const float amount_range2) {
