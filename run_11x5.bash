...
# 用valgrind啟動 抓漏
#sudo valgrind ./bin/optimize_opencode -k 11x5
#sudo valgrind --leak-check=full --show-leak-kinds=all --verbose --log-file=Valgrind.log ./bin/optimize_opencode -k 11x5
